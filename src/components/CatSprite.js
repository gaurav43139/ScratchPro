...
export default function CatSprite({ id, position = { x: 0, y: 0 }, rotation = 0, isSelected, onClick, sprites = [] }) {
  ...
  const checkCollision = () => {
    ...
    sprites.forEach((otherSprite) => {
      if (otherSprite.id !== id) {
        ...
        if (
          currentSpriteRect.x < otherSpriteRect.x + otherSpriteRect.width &&
          currentSpriteRect.x + currentSpriteRect.width > otherSpriteRect.x &&
          currentSpriteRect.y < otherSpriteRect.y + otherSpriteRect.height &&
          currentSpriteRect.y + currentSpriteRect.height > otherSpriteRect.y
        ) {
